...
import com.daiwei.common.support.CollectionKit;


/**
 *
 * @author  david:
 * @date 创建时间：2017年8月28日 下午10:58:53
 * @version 1.0
 * @parameter
  * @since 
 * @return 
...
public class StringKit extends StringUtils {
	...
	public static String joinStringArray(String[] array,String delimiters){
		if (array == null)
            return "";
	...
	public static ByteBuffer byteBuffer(String str, String charset) {
		return ByteBuffer.wrap(StringKit.bytes(str, charset));
	}
