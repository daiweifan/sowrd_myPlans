        ...
        <div class="form-horizontal" id="departmentInfoForm">
            ...
            <div class="row">
                <div class="col-sm-6 b-r">
                    <@u.input id="name" labelName="部门名称" underline="true" required="true"/>

                    <@u.input id="code" labelName="部门编号" underline="true" required="true"/>
            ...
            <div class="row btn-group-m-t">
                <div class="col-sm-10">
                    <@u.button class="btn-info" value="提交" id="ensure" icon="fa-check" clickFun="DepartmentInfoDlg.addSubmit()"/>
